 ...
 */
package dev.nuts.kafka.avro.model;
...
public class StreamAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -69411927657369638L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StreamAvroModel\",\"namespace\":\"dev.nuts.kafka.avro.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",\"string\"]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public StreamAvroModel(java.lang.Long userId, java.lang.Long id, java.lang.CharSequence text, java.lang.Long createdAt) {
    this.userId = userId;
    this.id = id;
    this.text = text;
   ...
   */
  public static dev.nuts.kafka.avro.model.StreamAvroModel.Builder newBuilder() {
    return new dev.nuts.kafka.avro.model.StreamAvroModel.Builder();
  }
   ...
   * @return A new StreamAvroModel RecordBuilder
   */
  public static dev.nuts.kafka.avro.model.StreamAvroModel.Builder newBuilder(dev.nuts.kafka.avro.model.StreamAvroModel.Builder other) {
    if (other == null) {
      return new dev.nuts.kafka.avro.model.StreamAvroModel.Builder();
    } else {
      return new dev.nuts.kafka.avro.model.StreamAvroModel.Builder(other);
    }
  }
   ...
   * @return A new StreamAvroModel RecordBuilder
   */
  public static dev.nuts.kafka.avro.model.StreamAvroModel.Builder newBuilder(dev.nuts.kafka.avro.model.StreamAvroModel other) {
    if (other == null) {
      return new dev.nuts.kafka.avro.model.StreamAvroModel.Builder();
    } else {
      return new dev.nuts.kafka.avro.model.StreamAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StreamAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.nuts.kafka.avro.model.StreamAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.nuts.kafka.avro.model.StreamAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.nuts.kafka.avro.model.StreamAvroModel.Builder clearCreatedAt() {
      createdAt = null;
